...
const reviews = [
  ...
  { name: "Jennifer M.", location: "Henderson, NV", text: "I've dealt with contractors who subcontract everything. Zenith's in-house crew made all the difference. You can tell they take pride in their work.", rating: 5 },
  ...
  { name: "Maria S.", location: "Henderson, NV", text: "Our roof had been leaking for months. Zenith found the issue quickly, explained our options, and had it repaired the same week. Professional and reliable.", rating: 5 },
];
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <AnimatedSection className="max-w-3xl mb-20">
            ...
            <p className="text-lg text-muted-foreground font-body leading-relaxed">
              Don't just take our word for it. Here's what Las Vegas and Henderson homeowners say about working with Zenith Roofing Solutions.
            </p>
          </AnimatedSection>
